...
jQuery.fn.keyboard = function(options){
	...
	var make = function(){
		...
		<div class="keyboard_norm keyboard_type num">\
			<table class="keyboard_row">\
				...
				<tr>\
					...
					<td><span class="keyboard_key backspace" style="width:62px;text-align:center;"><span class="keyboard_key-m">←</span></span></td>\
				</tr>\
			</table>\
		</div>\
		<div class="keyboard_norm keyboard_type phone">\
			<table class="keyboard_row">\
				<tr>\
					<td><span class="keyboard_key"><span class="keyboard_key-m">1</span></span></td>\
					<td><span class="keyboard_key"><span class="keyboard_key-m">2</span></span></td>\
				...
				<tr>\
					<td><span class="keyboard_key"><span class="keyboard_key-m">0</span></span></td>\
					<td colspan="2"><span class="keyboard_key backspace" style="width:128px;text-align:center;"><span class="keyboard_key-m">←</span></span></td>\
				</tr>\
			</table>\
		</div>\
		...
		var $keyboard = $('<div class="key_board" style="height:298px"></div>');
		...
		$this.focus(function(){
			$keyboard.css({left:'', right:''});
			$keyboard.css({top:$this.offset().top + 70, left:$this.offset().left}).fadeIn(0);
			if($keyboard.offset().left+$keyboard.width() > $(window).width()){
				$keyboard.css({left:'', right:10});
			}
		});
		$this.blur(function(){
			$keyboard.css({left:'', right:''});
			$keyboard.css({top:$this.offset().top + 50, left:$this.offset().left}).fadeOut(0);
			if($keyboard.offset().left+$keyboard.width() > $(window).width()){
				$keyboard.css({left:'', right:10});
			}
		});
