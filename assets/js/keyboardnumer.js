...
(function ($) {
    $.fn.numkeyboard = function (options) {
        ...
        this.each(function () {
            numkeyboardcount++;
            //添加唯一的数字键盘 class='number_list' id='number_list'  id='auth_keybord_menu' class='auth_keybord_menu'
            ...
            //元素css样式控制
            keyboard.css({
                "position": "absolute", "z-index": "10", "display": "none", "background": options.mainbackground, overflow: "hidden",
                "width": keyboardRadix * 0.6, "height": keyboardRadix * 0.5, "border-radius": keyboardRadix * 0.01
            });
            keyboard_exit.css({
                "position": "absolute", "z-index": "1", "right": "0", "background": options.exitbackground, "cursor": "pointer", "text-align": "center",
            ...
            keyboard_menu.css({
                position: "relative", background: options.menubackground, cursor: "move", margin: "auto",
            ...
            keyboard_button.css({
                "position": "relative", "float": "left", padding: "0", "cursor": "pointer", "background": options.buttonbackground, "text-align": "center",
